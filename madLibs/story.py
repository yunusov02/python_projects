adjectives = ["sparkly", "gigantic", "mysterious", "noisy", "smelly", "fuzzy", "gloomy", "silly", "brave", "colorful"]
nouns = ["octopus", "castle", "giraffe", "balloon", "keyboard", "computer", "banana", "wizard", "cloud", "robot"]
places = ["moon", "park", "beach", "forest", "mountain", "school", "city", "zoo", "desert", "lake"]
verbs = ["dance", "sing", "jump", "run", "skip", "swim", "fly", "hug", "climb", "laugh"]
